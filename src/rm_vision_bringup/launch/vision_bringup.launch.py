...
def generate_launch_description():
    ...
    from common import node_params, launch_params, robot_state_publisher, tracker_node,target_solve_node
    ...
    delay_target_solve_node = TimerAction(
        period=2.5,
        actions=[target_solve_node],
    )
