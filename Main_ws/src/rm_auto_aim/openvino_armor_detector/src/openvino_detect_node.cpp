...
: Node("openvino_detect_node", options.use_intra_process_comms(true))
{
  ...
  //实例化检测器
  string model_path_xml="/home/spr/rm_vision-develop_test/src/openvino_armor_detector/model/0708.xml";
  string model_path_bin="/home/spr/rm_vision-develop_test/src/openvino_armor_detector/model/0708.bin";
  string device="GPU";
